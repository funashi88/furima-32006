class OrderAddress
  ...
  attr_accessor :post_code, :prefecture_id, :municipality, :house_number, :building_name, :phone_number, :user_id, :item_id
  ...
  with_options presence: true do
    ...
    validates :phone_number,     format: { with: /[0-9]/, message: "input only number" }
  end
